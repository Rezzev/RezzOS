...
MAIN_PACKAGES="libeconf-0.6.3-r0.apk zstd-libs-1.5.6-r0.apk xz-libs-5.8.3-r0.apk ncurses-terminfo-base-6.4_p20240420-r2.apk dhcpcd-10.0.6-r1.apk libncursesw-6.4_p20240420-r2.apk libevent-2.1.12-r7.apk tmux-3.4-r1.apk readline-8.2.10-r0.apk bash-5.2.26-r0.apk nano-8.0-r0.apk dropbear-2024.85-r0.apk dropbear-ssh-2024.85-r0.apk zlib-1.3.2-r0.apk musl-dev-1.2.5-r3.apk musl-1.2.5-r3.apk make-4.4.1-r2.apk lua5.3-5.3.6-r6.apk lua5.3-libs-5.3.6-r6.apk linenoise-1.0-r5.apk syslinux-6.04_pre1-r15.apk e2fsprogs-1.47.0-r5.apk e2fsprogs-libs-1.47.0-r5.apk libcom_err-1.47.0-r5.apk dosfstools-4.2-r2.apk sfdisk-2.40.1-r1.apk libfdisk-2.40.1-r1.apk libsmartcols-2.40.1-r1.apk device-mapper-libs-2.03.23-r3.apk grub-2.12-r5.apk grub-bios-2.12-r5.apk grub-efi-2.12-r5.apk"
